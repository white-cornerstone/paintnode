...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ai::workflow_director::review_workflow_candidates,
            ai::workflow_director::plan_workflow_asset_extraction,
            ...
            ai::grok::detect_grok,
            ai::grok::discover_grok_capabilities,
