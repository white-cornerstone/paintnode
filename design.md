...
PaintNode uses a compact desktop image-editing UI. Keep controls dense, quiet, and consistent across panels and modal dialogs.
...
- Avoid local modal-only type scales unless there is a clear product reason. Dialogs such as `Modal.svelte`, Generate Image (AI), and custom image-editor dialogs should share the same 12px title/control rhythm.
