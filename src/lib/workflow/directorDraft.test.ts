...
function campaignDraft(): WorkflowDirectorGraphDraft {
  return {
    ...
    nodes: [
      ...
      { id: 'format-square', type: 'transform', title: 'Adapt Square', capability: 'generate', instructions: 'Adapt the accepted direction to Square 1:1.' },
    ...
    edges: [
      ...
      { id: 'format-square-output', source: { nodeId: 'format-square', portId: 'result' }, target: { nodeId: 'square', portId: 'source' } },
